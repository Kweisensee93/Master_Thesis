#!/bin/bash
#SBATCH --job-name=07_run_DLModels
#SBATCH --output=../logs/07_run_DLModels_%j.out
#SBATCH --error=../logs/07_run_DLModels_%j.err
...
python \
    /storage/homefs/kw23y068/Master_Thesis/scripts/DL_model_run.py \
