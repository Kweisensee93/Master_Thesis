...
if __name__ == "__main__":
    ...
    if not MODEL_PATH.exists():
        print(f"No trained model found at {MODEL_PATH}. Initiating training first...")
        MODEL_DIR.mkdir(parents=False, exist_ok=True)
        from DL_learning import main as train_main
        train_main()  # This will train the model and save it to MODEL_PATH
    else:
        print(f"Found trained model at {MODEL_PATH}. Proceeding with predictions...")
